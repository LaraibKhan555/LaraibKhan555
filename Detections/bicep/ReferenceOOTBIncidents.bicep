param workspace string = 'securimentLAW'

resource ootb 'Microsoft.OperationalInsights/workspaces/providers/alertRules@2022-11-01-preview' = {
  name: '${workspace}/Microsoft.SecurityInsights/90bf53b7-715f-4e78-9e60-bfb85fa967a8'
  kind: 'Scheduled'
  properties: {
